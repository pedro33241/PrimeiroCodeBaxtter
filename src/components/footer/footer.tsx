...
{isVisible && (
      ...
      >
       <span className="text-[14px] -mt-3 flex justify-center "> <svg xmlns="http://www.w3.org/2000/svg" width="23" height="46" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
